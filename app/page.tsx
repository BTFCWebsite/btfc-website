...
const NEWS = [
  ...
  { category: 'Tickets', color: '#7C3AED', icon: '🎟', date: '21 May 2026', title: '2026/27 Season Tickets Now on Sale', summary: 'Season tickets for the 2026/27 campaign are now available online. Adult £89 · Concession £69.' },
