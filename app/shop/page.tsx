  ...
  return (
    <main style={{ background: '#F2F2F2', minHeight: '100vh', padding: '52px 24px 90px' }}>
      <div style={{ maxWidth: 980, margin: '0 auto' }}>
        ...
        {/* Banner */}
        <div style={{ background: '#041B5F', borderRadius: 8, padding: '32px 36px', marginBottom: 36, display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap' }}>
          ...
          <div style={{ flex: 1 }}>
            ...
            <div style={{ background: 'rgba(255,255,255,.08)', borderRadius: 6, padding: '8px 14px', display: 'inline-block', fontFamily: "'Montserrat', sans-serif", fontSize: 11, color: 'rgba(255,255,255,.5)', marginBottom: 16 }}>
              ℹ Please allow 3–4 weeks for delivery. Items with club badge are non-returnable.
            </div>
            <div>
              <a href={SHOP_URL} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: '#1149D8', color: '#fff', padding: '14px 28px', borderRadius: 6, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: 16, letterSpacing: '.06em', textDecoration: 'none', textTransform: 'uppercase' }}>
                Visit Club Shop →
              </a>
            </div>
          </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 20, marginBottom: 36 }}>
          {PRODUCTS.map(p => (
            <a key={p.title} href={SHOP_URL} target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{ background: '#fff', border: '1px solid #E5E7EB', borderRadius: 8, padding: 24, textAlign: 'center', height: '100%' }}>
                ...
                <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 12, color: '#6B7280', lineHeight: 1.6, marginBottom: 14 }}>{p.desc}</div>
        ...
        {/* CTA */}
        <div style={{ textAlign: 'center', background: '#041B5F', borderRadius: 8, padding: '40px 24px' }}>
          <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: 32, color: '#fff', letterSpacing: '.04em', marginBottom: 8 }}>
            Support Your Club
          </div>
          <div style={{ fontFamily: "'Montserrat', sans-serif", fontSize: 13, color: 'rgba(255,255,255,.6)', marginBottom: 24, maxWidth: 440, margin: '0 auto 24px' }}>
            Every purchase helps support Brimscombe & Thrupp FC. Wear your colours with pride.
          </div>
          <a href={SHOP_URL} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', background: '#1149D8', color: '#fff', padding: '16px 36px', borderRadius: 6, fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 800, fontSize: 18, letterSpacing: '.06em', textDecoration: 'none', textTransform: 'uppercase', boxShadow: '0 8px 28px rgba(17,73,216,.45)' }}>
            Visit Club Shop →
          </a>
        </div>
