export default function ShopPage() {
  ...
  price: "£29.50",
  brand: "Joma",
  url: url: "https://www.batemanssports.co.uk/products/joma-brimscombe-thrupp-fc-managers-olimpiada-pants-black-black-019972?_pos=15&_sid=2e4f3c1a5&_ss=r",,
  image: "https://www.batemanssports.co.uk/cdn/shop/files/1722692313_019972_BLACK_3.jpg?v=1730903663&width=533",
    ...
    },
    {
      ...
      image: "https://www.batemanssports.co.uk/cdn/shop/files/1723124988_019974_BLACK_1.jpg?v=1730903689&width=533",
    },
    {
      name: "Stadium Scarf",
      price: "£12.00",
    ...
    <main style={{ background: "#F2F2F2", minHeight: "100vh", padding: "96px 24px 80px" }}>
      <section style={{ maxWidth: 1180, margin: "0 auto" }}>
        <div style={{ textAlign: "center", marginBottom: 42 }}>
          <h1 style={{ fontSize: 48, fontWeight: 950, color: "#2D2D2D", marginBottom: 8 }}>
            Club Shop
          </h1>
        ...
        >
          <img src="/crest.png" alt="BTFC crest" style={{ width: 74, height: 74 }} />
          <div style={{ flex: 1, minWidth: 260 }}>
            <h2 style={{ margin: "0 0 8px", fontSize: 32, fontWeight: 950 }}>
              Official BTFC Merchandise
            </h2>
            <p style={{ margin: "0 0 14px", color: "rgba(255,255,255,.72)", lineHeight: 1.6 }}>
              Browse the BTFC range hosted by Batemans Sports. Product tiles open the Batemans shop in a new tab.
            </p>
            <div style={{ fontSize: 12, color: "rgba(255,255,255,.68)" }}>
        ...
        >
          {products.map((p) => (
            ...
            >
              <div style={{ background: "#fff", height: 230, display: "flex", alignItems: "center", justifyContent: "center", padding: 18 }}>
                <img
                  src={p.image}
                  alt={p.name}
              ...
              <div style={{ padding: 18, borderTop: "1px solid #EEF2F7" }}>
                <div style={{ fontSize: 10, fontWeight: 900, color: "#1149D8", textTransform: "uppercase", marginBottom: 8 }}>
                  {p.brand}
                </div>
                <h2 style={{ fontSize: 18, color: "#2D2D2D", fontWeight: 950, margin: "0 0 10px", lineHeight: 1.2 }}>
                  {p.name}
                </h2>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
                  <div style={{ fontSize: 22, color: "#041B5F", fontWeight: 950 }}>{p.price}</div>
                  <span style={{ fontSize: 12, color: "#1149D8", fontWeight: 900, textTransform: "uppercase" }}>
                    View →
                  </span>
                </div>
              </div>
